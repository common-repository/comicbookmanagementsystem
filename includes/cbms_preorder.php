<?php
    ...
    $ncbd = date("Y-m-d", strtotime("next Wednesday"));
...
?>
    <div id = "cbms_preorder">
        <h2>Pre-Order Now</h2>
        <div id = "cbms_preorder_slider" class="owl-carousel owl-theme">
<?php                   
...
<?php
            if( $bookcount == 0 )
              {
?>
                <div class = "cbms_nobooks">No Books Available to Pre-Order</div>
<?php             
              }
?>      
    </div>